...
public class Controller {
    ...
    public Map<String,String> adicionarFacto(@RequestParam String fact){
        ...
        //Query de consulta
        Query consult = new Query("consult('C://Users/joaog/Desktop/sbcBackend/TarefaA/src/main/java/prolog/Parte1/res.pl').");
    ...
    @GetMapping("/assert2")
    public Map<String,String> adicionarFacto2(@RequestParam String fact){
        System.out.println("facto -> "+fact);
        //Query de consulta
        Query consult = new Query("consult('C://Users/joaog/Desktop/sbcBackend/TarefaA/src/main/java/prolog/Parte2/res.pl').");
        System.out.print("consult()-> ");
        System.out.println(consult.hasSolution());
        //Query de adicionar uma escolha
        Query query = new Query("escolher('"+fact+"').");
    ...
    @GetMapping("/res2")
    public ArrayList<ArrayList<String>> getResposta2(){
        //Query de Consult
        Query consult = new Query("consult('C://Users/joaog/Desktop/sbcBackend/TarefaA/src/main/java/prolog/Parte2/res.pl').");
        System.out.println(consult.hasSolution());
        //Query da resposta
